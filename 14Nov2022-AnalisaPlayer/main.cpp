/* 
    Ryandhika Bintang Abiyyi
    NIM : A11.2021.13498
    Struktur Data : 4303 
    Tugas 14 November 2022 - Analisa Code
*/
#include<iostream>
#include<string.h>
#include<conio.h>
...
// inisialisasi Struct ini memuat 3 variable dengan tipe data string, int, dan pointer terhadap struct player itu sendiri
struct player   
{
    string nama;
    int nilai;
...
void nodebaru(string a, int b)
  /* Prosedur Pembuatan Node, ketika kondisi Objek masih kosong */ 
{
...
/* Prosedur Insert Node (Object baru) di posisi belakang Node */
{
	player *baru;   // Deklarasi variable pointer bernama baru dengan tipe data struct player
	baru=new player;    // Membuat object secara dinamis, kemudian alamat dari object baru tersebut akan di storing kedalam variable pointer baru
	baru->nama=a;   // Object baru dengan atribut nama akan diisi dengan value pada variable a (dari parameter fungsi)
...
/* Prosedur Insert Node (Object baru) di posisi depan Node */
{
	player *baru;   // Deklarasi variable pointer bernama baru dengan tipe data struct player
	baru=new player;    // Membuat object secara dinamis, kemudian alamat dari object baru tersebut akan di storing kedalam variable pointer baru
	baru->nama=a;   // Object baru dengan atribut nama akan diisi dengan value pada variable a (dari parameter fungsi)
...
void deletebelakang()
/* Prosedur menghapus data paling belakangProsedur menghapus data paling belakang */
{
	...
	while(bantu!=NULL)  // Kondisi loop akan berhenti apabila pointer bantu menjadi NULL
	{
		...
		{
			bantu->next=NULL;   // Pointer bantu mengakses atribut pointer next dan diisikan NULL, apabila tidak diinisialisasi dengan NULL maka pointer next bisa mengarah ke alamat manapun di memori kita Bisa menyebabkan bad memory allocation dan crash pada program
...
/* Prosedur menambah node baru ke tengah */
{
